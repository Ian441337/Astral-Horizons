...
public class ArcFurnaceMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ArcFurnaceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AstralHorizonsModMenus.ARC_FURNACE.get(), id);
