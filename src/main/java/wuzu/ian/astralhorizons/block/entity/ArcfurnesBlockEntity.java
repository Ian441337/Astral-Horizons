...
public class ArcfurnesBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ArcfurnesBlockEntity(BlockPos position, BlockState state) {
		super(AstralHorizonsModBlockEntities.ARCFURNES.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("arcfurnes");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ArcfurnesguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
